...
def package(output):
    ...
    allowed.extend(ROOT/name for name in ('README.md','STATUS.md','FORMAT.md','BUILD_HOST.md','LAUNCH_STATUS.md','STARTUP_DIAGNOSTICS.md','MOVEMENT_TEST.md','TERRAIN_DECODER.md','TERRAIN_TEST.md','ENEMY_TEST.md','Makefile','cia.rsf','.gitignore'))
    manifest={}
    for p in allowed:
