...
def main():
    ...
    for file in [ROOT / "source/core.c", ROOT / "source/main.c", ROOT / "source/movement.c", ROOT / "source/terrain.c", ROOT / "source/enemies.c", ROOT / "include/enemies.h", ROOT / "include/terrain.h", ROOT / "include/movement.h", ROOT / "include/core.h", ROOT / "cia.rsf", Path(__file__)]:
    ...
    objects = []
    for name in ("core", "movement", "terrain", "enemies", "main"):
        obj = out / (name + ".o")
